#!/usr/bin/env python3
"""Ingest first-author 2026-05-26 supplemental files into plotting-derived tables.

Inputs:
  plot/data/first_author_update/urology_expert_evaluation_collection/*.xlsx
  plot/data/first_author_update/critical_defect.docx
Outputs:
  plot/data/derived/expert_ratings_updated.csv
  plot/data/derived/expert_rating_item_summary_updated.csv
  plot/data/derived/source_detection_updated.csv
  plot/data/derived/source_detection_metrics_updated.csv
  plot/data/derived/source_task_ratings_updated.csv
  plot/data/derived/critical_defect_taxonomy_updated.csv
"""
...
from project_paths import PLOT_DERIVED_DATA_DIR, PLOT_DIR  # noqa: E402

PLOT_ROOT = PLOT_DIR
DATA_DIR = PLOT_ROOT / "data" / "first_author_update"
...
def main() -> None:
    ...
    if not low_match.empty:
        print("WARNING: low fuzzy matches detected; see plot/data/derived/expert_rating_match_qc_updated.csv")
