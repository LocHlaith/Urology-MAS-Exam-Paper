...
LAYOUTS = {
    ...
    "Figure2": FigureLayout(
        ...
        slots=(
            ...
            Slot("B", "Figure2B_quality_difference.pdf", 0, 1, 2, 1),
            Slot("C", "Figure2C_dimension_scores.pdf", 2, 1, 1, 2),
            Slot("D", "Figure2D_quality_by_cognitive_level.pdf", 0, 2, 2, 1),
            Slot("E", "Figure2E_expert_quality_source_cognitive_interaction.pdf", 0, 3, 2, 1),
            Slot("F", "Figure2F_expert_inter_rater_reliability.pdf", 2, 3, 1, 1),
        ),
    ),
    "Figure3": FigureLayout(
        ...
        slots=(
            ...
            Slot("B", "Figure3B_reliability.pdf", 2, 0, 1, 1),
            Slot("C", "Figure3C_student_correct_rate.pdf", 0, 1, 3, 1),
            Slot("D", "Figure3D_student_accuracy_by_cognitive_level.pdf", 0, 2, 3, 1),
            Slot("E", "Figure3E_source_cognitive_interaction.pdf", 0, 3, 2, 1),
            Slot("F", "Figure3F_ctt_by_cognitive_level.pdf", 2, 3, 1, 1),
        ),
    ),
    ...
    "Figure5": FigureLayout(
        ...
        rows=2,
        slots=(
            Slot("A", "Figure5A_total_workflow_time.pdf", 0, 0, 1, 1),
            Slot("B", "Figure5B_time_per_usable_item.pdf", 1, 0, 1, 1),
            Slot("C", "Figure5C_time_sensitivity.pdf", 2, 0, 1, 1),
            Slot("D", "Figure5D_api_cost.pdf", 0, 1, 2, 1),
            Slot("E", "Figure5E_total_cost_comparison.pdf", 2, 1, 1, 1),
        ),
    ),
