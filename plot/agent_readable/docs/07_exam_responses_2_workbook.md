# 转换来源： `plot/raw/试卷作答情况 - 2.xlsx`

## 转换元数据

- 来源路径： `plot/raw/试卷作答情况 - 2.xlsx`
...
本文件和对应 CSV 只是 `plot/raw/试卷作答情况 - 2.xlsx` 的机械导出。已确认：M卷 = MAS，P卷 = 人类。不要把该映射反写；其他最终分析变量仍需从 workbook、sheet、单元格和锁定分析数据追溯确认。
