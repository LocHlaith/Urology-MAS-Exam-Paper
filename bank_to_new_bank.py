...
PROMPT_FILES = {
    "A1": os.path.join(ROOT, "prompts_for_bank_to_new_bank_a1.txt"),
    "A2": os.path.join(ROOT, "prompts_for_bank_to_new_bank_a2.txt"),
    "A3": os.path.join(ROOT, "prompts_for_bank_to_new_bank_a3.txt"),
    "A4": os.path.join(ROOT, "prompts_for_bank_to_new_bank_a4.txt"),
    "B":  os.path.join(ROOT, "prompts_for_bank_to_new_bank_b.txt"),
    "X":  os.path.join(ROOT, "prompts_for_bank_to_new_bank_x.txt"),
}
